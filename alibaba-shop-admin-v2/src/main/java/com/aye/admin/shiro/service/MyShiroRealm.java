//package com.aye.admin.shiro.service;
//
//import com.aye.admin.mapper.SysPermissionMapper;
//import com.aye.admin.mapper.SysRoleMapper;
...
//
//	@Autowired
//	private SysPermissionMapper sysPermissionMapper;//权限dao
//
//	@Autowired
...
//		SysUser userInfo = sysUserMapper.queryUserName(username);
...
//		List<SysRole> tsysRoles= sysRoleMapper.queryUserRole(uid);
//		for(SysRole userrole:tsysRoles){
...
//			List<SysPermission> permissions=sysPermissionMapper.queryRoleId(rolid);
