...
import com.aye.commons.dto.BaseResponse;
import com.aye.commons.ex.assertion.CommonExceptionAssert;
...
@Getter
@AllArgsConstructor
public enum CommonErrorEnum implements CommonExceptionAssert {
    ...
    /**
     * 5***，一般对应于{@link com.aye.commons.ex.exception.ArgumentException}，系统封装的工具出现异常
     */
