...
public class DataProduct1 implements Serializable {
     ...
     */
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @TableField( value = "d_createtime" ,fill = FieldFill.INSERT)
     ...
     */
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @TableField(value = "d_modifiedtime", fill =FieldFill.UPDATE)
